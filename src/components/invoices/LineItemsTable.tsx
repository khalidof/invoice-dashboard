      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-slate-200">
            ...
            <th className="text-right py-2 text-xs font-semibold text-slate-500 uppercase tracking-wider w-20">
              Qty
            </th>
            <th className="text-right py-2 text-xs font-semibold text-slate-500 uppercase tracking-wider w-28">
              Unit Price
            </th>
            <th className="text-right py-2 text-xs font-semibold text-slate-500 uppercase tracking-wider w-28">
              Amount
